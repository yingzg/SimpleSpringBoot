...
import com.example.express.Common.ReturnUtil.CommonResult;
import com.example.express.Common.ReturnUtil.ResultCode;
...
public class ApiRequestLimitAspect {
    ...
    @Pointcut(value = "@annotation(com.example.express.AOP.ApiRequestLimit)")
    public void pointcut() {
    }

    @Around(value = "pointcut() && @annotation(control)")
    public Object around(final ProceedingJoinPoint point, final ApiRequestLimit control) throws Throwable {
        // 获取请求方法
...
//            response.setStatus(HttpStatus.TOO_MANY_REQUESTS.value());
            return CommonResult.failed(ResultCode.REQUEST_TOO_HIGH);
        }
    ...
    private static int[] limitMaxAndExpire(final ApiRequestLimit control) {
